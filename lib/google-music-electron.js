...
var gme = {
  ...
  reloadWindow: function () {
    ...
    changeSite: function () {
        logger.debug('Changing site url');
        gme.browserWindow.webContents.loadURL(config.get('site-url'))
    },
    browserBack: function () {
        logger.debug('Browser back');
        gme.browserWindow.webContents.goBack()
    },
...
function launchGme() {
  ...
  gme.browserWindow.loadURL(config.get('site-url'));
